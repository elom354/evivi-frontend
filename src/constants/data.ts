...
export const ONBOARDING_SLIDES: OnboardingSlide[] = [
  {
    ...
    title: 'Algorithme',
    description:
      'Les utilisateurs passent par un processus de vérification pour garantir que vous ne correspondrez jamais avec des bots.',
  ...
  },
  {
    ...
    description:
      "Nous vous mettons en relation avec des personnes qui ont un large éventail d'intérêts similaires.",
  ...
  },
  {
    ...
    title: 'Premium',
    description:
      "Inscrivez-vous aujourd'hui et profitez du premier mois d'avantages premium offert par nos soins.",
